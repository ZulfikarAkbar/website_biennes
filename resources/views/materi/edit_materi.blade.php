  ...
  <body style="background-image: url({{url('img/wall4.png')}})">
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="text-align: center; font-size: 20px; background-color: cornflowerblue; color:white;">{{ __('Perbarui nama materi') }}</div>
                <div class="card-body">
                <form method="post" action="/materi/{{$materi->id}}" enctype="multipart/form-data">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  ...
                                  <input type="text" placeholder="Masukkan nama materi" class="form-control {{ $errors->has('nama_soal') ? ' is-invalid' : '' }}" name="nama_soal" value="{{$materi->nama_soal}}" required autofocus>
                          ...
                          <div class="form-group row mb-0">
                              ...
                              <button type="submit" onclick="return confirm('Kamu yakin ingin memperbarui nama materi ini?');" class="btn btn-success" style="border-radius: 2em; background-color: cornflowerblue" value="update">
