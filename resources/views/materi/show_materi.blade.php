    ...
    <br><br><br><br><br><br><br>
      <section>
            <div class="container" style="font-size: 20px;">
                  ...
                  @endif
              <br><br>
              <h1 style="text-align: center;font-size: 50px"> <strong>Latihan soal</strong> </h1>
              <br><br>
              <div class="row">
                  <div class="col-xl-3">
                      <a class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Tambah materi" href="/materi/create_materi" role="button" style="font-size: 20px; border-radius: 2em">
                ...
                <table id="dtVerticalScrollExample">
                        <thead class="brown white-text">
                            <tr>
                                ...
                                <th class="th-lg" colspan="1" style="font-size: 20px; "  ><strong>Materi</strong>

                                </th>

                                <th class="th-lg" colspan="1" style="font-size: 20px; "><strong>Action</strong></th>
                        ...
                        <tbody style="background-color: lightsteelblue;">
                            ...
                            <tr>
                                ...
                                <td style="font-size: 20px">{{$materi->nama_soal}}</td>

                                <td >
                                <a href="/materi/{{$materi->id}}/update_materi" data-toggle="tooltip" data-placement="right" title="Edit materi" class="btn" style="font-size: 15px; background-color: green; color: white; border-radius: 2em" onclick="return confirm('Kamu yakin ingin memperbarui nama materi ini?');" ><i class="fa fa-edit" style="font-size: 15px; border-radius: 2em"> Edit</i></a>
                                <a href="/soal/admin/{{$materi->id}}" data-toggle="tooltip" data-placement="right" title="Buat soal untuk materi ini" class="btn" style="font-size: 15px; background-color: mediumslateblue; color: white;border-radius: 2em"  ><i class="fa fa-pencil" style="font-size: 15px; border-radius: 2em"> Buat soal</i></a>

                                    <form action="/materi/{{$materi->id}}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-danger" data-toggle="tooltip" data-placement="right" title="Hapus materi" type="submit" style="font-size: 15px; background-color: crimson; border-radius: 2em" onclick="return confirm('Kamu yakin ingin menghapus materi ini?');"><i class="fa fa-eraser" style="font-size: 15px">hapus</i></button>
