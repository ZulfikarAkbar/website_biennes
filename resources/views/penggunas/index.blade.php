    ...
    <br><br><br><br><br><br><br>
      <section>
            <div class="container" style="font-size: 20px;">
                  ...
                  @endif
              <br><br>
              <h1 style="text-align: center;font-size: 50px"> <strong>Pengguna Website</strong> </h1>
              <br><br>
              <div class="row">
                  <div class="col-xl-3">
                ...
                <table id="dtVerticalScrollExample">
                        <thead class="brown white-text">
                            <tr>
                                ...
                                <th class="th-lg" style="font-size: 15px; width: 153px"><strong>Nama</strong>
                                    
                                </th>
                                <!--<th><strong>Jam</strong></th>-->
                                <!--<th><strong>Ruang</strong></th>-->
                                <th class="th-lg" style="font-size: 20px;"><strong>E-Mail</strong>
                                    
                                </th>
                                <th class="th-lg" style="font-size: 20px; "  ><strong>Nomor telepon/handphone</strong>
                                    
                                </th>
                                
                                <th class="th-lg" style="font-size: 20px; "><strong>Action</strong></th>
                        ...
                        <tbody style="background-color: lightsteelblue;">
                            ...
                            <tr>
                                <!--<td style="font-size: 15px">{{$pengguna->id}}</td>-->
                                <td style="font-size: 20px">{{$pengguna->name}}</td>
                                <!--<td>{{$pengguna->kelas}}</td>-->
                                <!--<td>{{$pengguna->ruang}}</td>-->
                                <td style="font-size: 20px">{{$pengguna->email}}</td>
                                <td style="font-size: 20px">{{$pengguna->phone}}</td>
                               
                                <td >
                                    <form action="{{ route('penggunas.destroy', $pengguna->id)}}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-danger" data-toggle="tooltip" data-placement="right" title="Hapus pengguna" type="submit" style="font-size: 15px; background-color: tomato; border-radius: 2em" onclick="return confirm('Kamu yakin ingin menghapus user ini?');"><i class="fa fa-eraser" style="font-size: 15px;border-radius: 2em"> Hapus</i></button>
