        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                -->
                    ...
                    <li class="nav-item">
                        <a data-toggle="tooltip" data-placement="right" title="Buat soal quiz" class="nav-link" href="{{ url('/buat_soal') }}"><i style="font-size: 20px" class="fa fa-pencil">{{ __(' Buat Soal') }}</i></a>
                    </li>
                    <li class="nav-item">
    ...
    <br><br><br><br><br><br><br>
      <section>
            <div class="container" style="font-size: 20px;">
                  ...
                  @endif
              <br><br>
              <h1 style="text-align: center;font-size: 50px"> <strong>Materi</strong> </h1>
              <br><br>
              <div class="row">
                  <div class="col-xl-3">
                      <a class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Masukkan judul materi" href="materi/create" role="button" style="font-size: 20px; border-radius: 2em">
                ...
                <table id="dtVerticalScrollExample">
                        <thead class="brown white-text">
                            <tr>
                                ...
                                {{-- <th class="th-lg" style="font-size: 20px; "><strong>Pertanyaan</strong>
                                    
                                </th>
                                <!--<th><strong>Jam</strong></th>-->
                                <!--<th><strong>Ruang</strong></th>-->
                                <th class="th-lg" style="font-size: 20px;"><strong>A</strong>
                                    
                                </th>
                                <th class="th-lg" style="font-size: 20px;"><strong>B</strong>
                                    
                                </th>
                                <th class="th-lg" style="font-size: 20px;"><strong>C</strong>
                                    
                                </th>
                                <th class="th-lg" style="font-size: 20px;"><strong>D</strong>
                                    
                                </th>
                                <th class="th-lg" style ="font-size: 20px;"><strong>E</strong>
                                    
                                </th>
                                <th class="th-lg" style="font-size: 20px;"><strong>Benar</strong>
                                    
                                </th>
                                <th class="th-lg" style="font-size: 20px;"><strong>Pembahasan</strong>
                                    
                                </th> --}}
                                
                                
                                <th class="th-lg" colspan="2" style="font-size: 20px; "><strong>Action</strong></th>
                        ...
                        <tbody style="background-color: lightsteelblue;">
                            ...
                            <tr>
                                <!--<td style="font-size: 15px">{{$soal->id}}</td>-->
                                <td style="font-size: 20px">{{$materi->materi}}</td>
                                {{-- <td style="font-size: 20px">{{$soal->pertanyaan}}</td>
                                <!--<td>{{$soal->kelas}}</td>-->
                                <!--<td>{{$soal->ruang}}</td>-->
                                <td style="font-size: 20px">{{$soal->a}}</td>
                                <td style="font-size: 20px">{{$soal->b}}</td>
                                <td style="font-size: 20px">{{$soal->c}}</td>
                                <td style="font-size: 20px">{{$soal->d}}</td>
                                <td style="font-size: 20px">{{$soal->e}}</td>
                                <td style="font-size: 20px">{{$soal->jawaban}}</td>
                                <td style="font-size: 20px">{{$soal->penjelasan}}</td> --}}
                               
                                <td >
                                    <a href="{{ route('buat_soal.edit',$materi->id)}}" data-toggle="tooltip" data-placement="right" title="Update materi" class="btn" style="font-size: 15px; background-color: green; border-radius: 2em" onclick="return confirm('Kamu yakin ingin mengupdate materi ini?');" ><i class="fa fa-edit" style="font-size: 15px; border-radius: 2em"> Update</i></a>
                                        
                                    <form action="{{ route('buat_soal.destroy', $materi->id)}}" method="post">
                                        @csrf
                                        @method('DELETE')
