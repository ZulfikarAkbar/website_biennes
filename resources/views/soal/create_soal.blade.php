      ...
      <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                style="text-align: center; font-size: 20px; background-color: cornflowerblue; color:white;">{{ __('Masukkan soal') }}
              </div>
                <div class="card-body">
                  <form method="post" action="/soal/admin/{{$id}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row mb-0">
                              ...
                              <button type="submit" class="btn btn-success  btn-block" style="border-radius: 2em; background-color: cornflowerblue">
                                {{-- <i class="fa fa-plus"></i> --}}
                                {{ __('Submit') }}</button>
                                <a class="btn btn-primary btn-block" href="/soal/admin/{{$id}}" style="border-radius: 2em; background-color: tomato; color: white">
                                  {{-- <i class="fa fa-plus"></i> --}}
                                  {{ __('Batal') }}</a>
                            </div>
                          </div>
          ...
          <div class="span2">
            <a class="btn btn-primary btn-block" href="/soal/admin/{{$id}}" style="border-radius: 2em; width: 3em;background-color: tomato; color: white">
              {{-- <i class="fa fa-plus"></i> --}}
              {{ __('X') }}</a>
          </div>
        </div>
