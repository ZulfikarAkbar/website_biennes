    ...
    <nav class="navbar navbar-dark brown navbar-expand-lg navbar-inverse fixed-top scrolling-navbar opaque-navbar">
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                -->
                    <li class="nav-item">
                        <a data-toggle="tooltip" data-placement="right" title="Lihat jadwal belajar siswa" class="nav-link" href="{{ url('/jadwals') }}"><i style="font-size: 20px" class="fa fa-eye">{{ __(' Jadwal') }}</i></a>
                    </li>
                    <li class="nav-item">
