            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a data-toggle="tooltip" data-placement="right" title="Lihat soal latihan" class="nav-link" href="/soal"><i style="font-size: 20px" class="fa fa-bullseye">{{ __(' Latihan soal') }}</i></a>
                        </li>
                          ...
                          <div class="col-4">
                                  ...
                                  <div class="card example hoverable" style="background-color: lightcyan; color: black;">
                                      ...
                                      <div class="card-body">
                                          ...
                                          <!-- Title -->
                                          <h1 class="card-title">{{$materi->nama_soal}}</h1>
                                    
                                          <p>
                                          <a href="soal/{{$materi->id}}" class="btn btn-info example hoverable z-depth-3" style="font-size: 15px; border-radius: 2em; background-color: cornflowerblue" data-toggle="tooltip" data-placement="right" title="Kerjakan latihan soal">Mulai Latihan</a>
                                          </p>
